...
function App() {
  ...
  const [connvertedAmount, setConvertedAmout] = useState(0)
  // const { data, error, isLoading } = useCurrencyInfo(from, to, amount)
              ...
              >
                  <div className="w-full mb-1">
                      <InputBox
                          ...
                          onCurrencyChange={(currencyy) => setAmount(amount)}
                          selectCurrency={from}
                      />
                  </div>
